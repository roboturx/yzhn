...
},{"process/browser.js":43,"timers":5}],6:[function(require,module,exports){
...
},{"../../modules/_core":12,"../../modules/es6.object.keys":42}],8:[function(require,module,exports){
...
},{"./_to-absolute-index":34,"./_to-iobject":36,"./_to-length":37}],11:[function(require,module,exports){
...
},{"./_descriptors":15,"./_object-dp":27,"./_property-desc":31}],23:[function(require,module,exports){
...
},{"./_array-includes":10,"./_has":21,"./_shared-key":32,"./_to-iobject":36}],29:[function(require,module,exports){
...
},{"./_enum-bug-keys":17,"./_object-keys-internal":28}],30:[function(require,module,exports){
...
},{"./_core":12,"./_export":18,"./_fails":19}],31:[function(require,module,exports){
...
},{"./_core":12,"./_global":20,"./_library":26}],34:[function(require,module,exports){
...
},{"./_defined":14,"./_iobject":24}],37:[function(require,module,exports){
// 7.1.15 ToLength
var toInteger = require('./_to-integer');
var min = Math.min;
module.exports = function (it) {
...
},{"./_defined":14}],39:[function(require,module,exports){
...
},{"_process":43,"timers":5}],48:[function(require,module,exports){
'use strict';
...
exports.default = {
    ...
    props: ['loggedInUser', 'subscriptionPage', 'userShouldSee'],

    events: {
        'login-happened': function loginHappened(loggedInUser) {
            this.loggedInUser = loggedInUser;
            this.userShouldSee = loggedInUser.shouldSee;
        },
        'logout-happened': function logoutHappened() {
            this.userShouldSee = true;
            this.loggedInUser = false;
        }
    }
};
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<section v-show=\"userShouldSee &amp;&amp; !subscriptionPage\">\n    <div class=\"footer-membership\">\n        <div class=\"container\">\n            <div class=\"row\" v-show=\"loggedInUser &amp;&amp; (loggedInUser.in_trial || !loggedInUser.has_subscription)\">\n                <div class=\"col-sm-8\">\n                    <h4>Jurix’e abone olmaya hazır mısınız?</h4>\n                    <h6>Yandaki butona tıklayarak abonelik seçeneklerini görebilirsiniz</h6>\n                </div>\n                <div class=\"col-sm-4 text-right\">\n                    <a href=\"/subscription\" class=\"btn btn-default btn-md\">Abone Ol</a>\n                </div>\n            </div>\n            <div class=\"row\" v-show=\"!loggedInUser\">\n                <div class=\"col-sm-8\">\n                    <h4>Jurix’i kullanmaya hazır mısınız?</h4>\n                    <h6>İster Hemen Abone Olun, İsterseniz 1 Hafta Deneme Aboneliğinden Faydalanın</h6>\n                </div>\n                <div class=\"col-sm-4 text-right\">\n                    <a href=\"#registerModal\" data-toggle=\"modal\" class=\"btn btn-jurix\">Ücretsiz Dene</a>\n                    <a href=\"/subscription\" class=\"btn btn-default btn-md\">Abone Ol</a>\n                </div>\n            </div>\n        </div>\n    </div>\n</section>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-05875faa", module.exports)
  } else {
    hotAPI.update("_v-05875faa", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"vue":47,"vue-hot-reload-api":44}],49:[function(require,module,exports){
"use strict";
...
exports.default = {
    data: function data() {
        return {
            validationOptionsForRegistration: {
                rules: {
                    membernameinfoV: "required",
                    memberlastnameinfoV: "required",
                    memberEmailInfo: {
                        required: true,
                        email: true,
                    ...
                    phone: "required",
                    id_no: "required",
                    billingNameInfo: "required",
                    billingAddress: "required",
                    billingDistrict: "required",
                    billing_city_id: "required",
                    billing_country_id: "required",
                    billingPhone: "required",
                    billing_id_no: "required",
                    billing_tax_no: "required",
                    billing_tax_office: "required",
                },
                errorElement: 'label',
                errorPlacement: function errorPlacement(error, element) {
                    if (element.attr('id') == 'iagree') {
                        var par = $(element).parents('.col-md-12').first();
                    } else if (error.text().indexOf('zaten') !== -1) {
                        var _swal;

                        swal((_swal = {
                            title: ""
                        }, (0, _defineProperty3.default)(_swal, "title", ""), (0, _defineProperty3.default)(_swal, "text", "Bu e-posta adresi sistemde kayıtlı. Lütfen önce giriş yapıp daha sonra abonelik satın almayı deneyin."), (0, _defineProperty3.default)(_swal, "html", true), (0, _defineProperty3.default)(_swal, "type", 'error'), (0, _defineProperty3.default)(_swal, "confirmButtonColor", '#d7172f'), (0, _defineProperty3.default)(_swal, "confirmButtonText", "Giriş Yap"), (0, _defineProperty3.default)(_swal, "showCancelButton", true), (0, _defineProperty3.default)(_swal, "cancelButtonColor", 'black'), (0, _defineProperty3.default)(_swal, "cancelButtonText", "Kapat"), _swal), function (isConfirm) {
                            if (isConfirm) {
                                $('#loginModalVue').modal('show');
                            }
                        });
                    } else {
                        var par = $(element).parents('.form-group').first();
                    }
                    error.addClass('errorSpan');
                    error.insertAfter(par);
                },
                messages: {
                    iagree: "Devam etmeden önce abonelik sözleşmesini kabul etmelisiniz",
                    membernameinfoV: "Adınızı girmeyi unuttunuz",
                    memberlastnameinfoV: "Soyadınızı girmeyi unuttunuz",
                    memberEmailInfo: {
                        required: "E-posta adresinizi girmeyi unuttunuz",
                        email: "Geçerli bir e-posta adresi girin.",
                        remote: "Bu e-posta adresi sistemde zaten kayıtlı.\
                            <br>Önce sisteme\
                            <a href=\"#loginModalVue\" data-toggle=\"modal\" style=\"text-decoration:underline;color:black;\"> giriş</a>\
                            yapın, ya da farklı bir e-posta adresi girin."
                    },
                    memberPasswordInfo: {
                        required: "Şifre belirlemeyi unuttunuz",
                        minlength: "En az 6 karakterden oluşan bir şifre girmelisiniz."
                    },
                    address: "Adresinizi girmeyi unuttunuz",
                    district: "Semtinizi girmeyi unuttunuz",
                    city_id: "Şehrinizi seçmeyi unuttunuz",
                    country_id: "Ülkenizi seçmeyi unuttunuz",
                    phone: "Telefonunuzu girmeyi unuttunuz",
                    id_no: "TC kimlik numaranızı girmeyi unuttunuz",
                    billingNameInfo: "Adınızı ve soyadınızı girmeyi unuttunuz",
                    billingAddress: "Adresinizi girmeyi unuttunuz",
                    billingDistrict: "Semtinizi girmeyi unuttunuz",
                    billing_city_id: "Şehrinizi seçmeyi unuttunuz",
                    billing_country_id: "Ülkenizi seçmeyi unuttunuz",
                    billingPhone: "Telefonunuzu girmeyi unuttunuz",
                    billing_id_no: "TC kimlik numaranızı girmeyi unuttunuz",
                    billing_tax_no: "Vergi numaranızı girmeyi unuttunuz",
                    billing_tax_office: "Vergi dairesini girmeyi unuttunuz.",
                    CCexpireMonth: {
                        required: "Kartınızın son kullanma tarihinin ay bilgisini iki hane olarak giriniz.",
                        minlength: "Kartınızın son kullanma tarihinin ay bilgisini iki hane olarak giriniz."
                    },
                    CCexpireYear: {
                        required: "Kartınızın son kullanma tarihinin yıl bilgisini iki hane olarak giriniz.",
                        minlength: "Kartınızın son kullanma tarihinin yıl bilgisini iki hane olarak giriniz.",
                        min: "Son kullanma tarihi 18'den büyük olmalıdır."
                    },
                    cc_cvv2: {
                        required: "Kartınızın arkasında bulunan 3 haneli güvenlik kodunu giriniz.",
                        minlength: "Kartınızın arkasında bulunan 3 haneli güvenlik kodunu giriniz."
                    }
                }
            },
            validationOptionsForPayment: {
                rules: {
                    CCexpireMonth: {
                        required: true,
                        minlength: 2
            ...
            picked: '', // Mukellef
            showForeign: false,
            differentBillingPerson: true,
            differentBillingCompany: false,
            differentBillingInstitution: false,
            billingPhone: '',
            billingDistrict: '',
            billingAddress: '',
            billingForeignCity: '',
            ...
            pricePerUser: '',
            numUsersAdded: 1,
            userForSubscriptionName: '',
            userForSubscriptionLastName: '',
            userForSubscriptionEmail: '',
    ...
    computed: {
        userFullName: function userFullName() {
            return this.memberName + ' ' + this.memberLastName;
        }
    },
    ready: function ready() {
        ...
        var theForm = $("#subscriptionForm");
        theForm.validate(this.validationOptions);
        if ((0, _keys2.default)(this.loggedInUser).length > 0) {
            if (this.loggedInUser.customer.address != null) {
                this.memberAddress = this.loggedInUser.customer.address.address;
                this.memberDistrict = this.loggedInUser.customer.address.district;
                this.memberCity = this.loggedInUser.customer.address.city_id;
                this.memberCountry = this.loggedInUser.customer.address.country_id;
                this.billing_city_id = this.memberCity;
                this.billing_country_id = this.memberCountry;
                this.memberPhone = this.loggedInUser.customer.address.phone;
                if (this.loggedInUser.customer.meta != null) {
                    this.memberIDNo = this.loggedInUser.customer.meta.tax_id_no;
                }
            }
            this.userFullName = this.loggedInUser.first_name + ' ' + this.loggedInUser.last_name;
            this.memberName = this.loggedInUser.first_name;
            this.memberLastName = this.loggedInUser.last_name;
            this.memberEmail = this.loggedInUser.email;
        }
    },

    props: ['countries', 'cities', 'subscriptionTypes', 'mem', 'loggedInUser'],
    methods: {
        loggedInUserExists: function loggedInUserExists() {
            return (0, _keys2.default)(this.loggedInUser).length > 0;
        },
        remoteValidation: function remoteValidation() {
            if (this.loggedInUserExists()) {
                return false;
            }
            return {
                url: "/chkdupemail",
                ...
                data: {
                    ...
                    email: function email() {
                        return $('[name=memberEmailInfo]').val();
                    }
                }
            };
        },
        forward: function forward() {
            ...
            if (this.currentStep == 2 || this.currentStep == 3) {
                ...
                theForm.validate(this.validationOptions);
                if (theForm.valid()) {
                    this['step' + this.currentStep] = false;
                    this.currentStep++;
                    this['step' + this.currentStep] = true;
                }
            } else {
        ...
        decreaseUserNum: function decreaseUserNum(typeid) {
            this['userNum' + typeid]--;
        },
        increaseUserNum: function increaseUserNum(typeid) {
            this['userNum' + typeid]++;
        },
        getUserNumForId: function getUserNumForId(typeid) {
            return this['userNum' + typeid];
        },
        checkLoginStatusAndGo: function checkLoginStatusAndGo(typeId) {
            this.selectedSubscriptionType = typeId;
            this.forward();
        },
        getNumUsers: function getNumUsers() {
            if (this.selectedSubscriptionType == 2 || this.selectedSubscriptionType == 3) {
                return this['userNum' + this.selectedSubscriptionType];
            } else {
                return 1;
            }
        },
        usersLeftToAdd: function usersLeftToAdd() {
            return this.getNumUsers() - this.numUsersAdded;
        },
        prepare: function prepare(e) {
            ...
            // return;
            var theForm = $("#subscriptionForm");
            theForm.validate(this.validationOptionsForRegistration);
            if (theForm.valid()) {
                e.preventDefault();
                // alert(2);
                ...
                // if (this.isLoading === false) {
                    var self = this;
                    var data = {
                        customer_id: (0, _keys2.default)(this.loggedInUser).length > 0 ? this.loggedInUser.customer.id : null,
                        first_name: this.memberName,
                        last_name: this.memberLastName,
                        email: this.memberEmail,
                        password: this.memberPassword,
                        address: this.memberAddress,
                        district: this.memberDistrict,
                        city_id: this.memberCity,
                        country_id: this.memberCountry,
                        phone: this.memberPhone,
                        tax_office: null,
                        tax_no: null,
                        id_no: this.memberIDNo,
                        membership_type: this.selectedSubscriptionType,
                        num_users: this.getNumUsers(),
                        ccPicked: this.CCpicked,
                        // ccNumber: this.CCnumber,
                        // ccExpire: this.CCexpireMonth + this.CCexpireYear,
                        // ccNameOnCard: this.CCnameOnCard,
                        // ccCVV: this.CCcvv,
                        recaptcha: grecaptcha.enterprise.getResponse(),
                        _token:  document.querySelector('#token').getAttribute('value'),
                        usersForSubscription: this.usersForSubscription,
                        sameBillingInfo: this.sameBillingCheckbox ? 'yes' : 'no',
                        billingAddress: this.billingAddress,
                        billingDistrict: this.billingDistrict,
                        billing_city_id: this.sameBillingCheckbox ? this.memberCity : this.billing_city_id,
                        billing_country_id: this.sameBillingCheckbox ? this.memberCountry : this.billing_country_id,
                        billing_id_no: this.picked == 'person' ? this.billing_id_no : null,
                        billingNameInfo: this.billingNameInfo,
                        billing_tax_no: this.picked != 'person' ? this.billing_tax_no : null,
                        billing_tax_office: this.picked != 'person' ? this.billing_tax_office : null
                    };
                    // this.isLoading = true;
                    self.$http.post('/subscription/prepare', data).then(function (response) {
                        if(response.body.success){
                            // _this['step' + _this.currentStep] = false;
                            // _this.currentStep++;
                            // _this['step' + _this.currentStep] = true;
                            window.document.location.href='/subscription/startpayment?id='+response.body.id;
                        }
                        return ;
                        ...
                        if (response.body == 'success') {
                            ...
                            swal({
                                title: "",
                                text: "Bu e-posta adresi sistemde kayıtlı. Lütfen önce giriş yapıp daha sonra abonelik satın almayı deneyin.",
                                html: true,
                                type: 'error',
                                confirmButtonColor: '#d7172f',
                                confirmButtonText: "Giris Yap"
                                // email remote
                                // butona basinca login modal
                                // cancel button
                            });
                        } else if (response.body == 'subscription-start') {
                            //this.subscriptionStart = true;
                            swal({
                                title: "",
                                text: "Jurix'e hoşgeldiniz! Aboneliğiniz Başlamıştır.",
                                html: true,
                                type: 'success',
                                confirmButtonText: "Kapat"
                            }, function (isConfirm) {
                                if (isConfirm) {
                                    window.location.href = 'https://www.jurix.com.tr';
                                }
                            });
                        } else if (response.body.hasOwnProperty('payment-error')) {
                            _this.loggedInUser = response.body['payment-error'];
                            _this.back();
                            _this.$dispatch('bridge', 'payment-error', _this.loggedInUser);
                            swal({
                                title: "",
                                text: "Bankadan Ödeme Onayı Alınamadı, lütfen Kredi Kartı Bilgilerinizi Kontrol Edin.",
                                html: true,
                                type: 'error',
                                confirmButtonColor: '#d7172f',
                                confirmButtonText: "Kapat"
        ...
        submitForm: function submitForm(e) {
            ...
            if (theForm.valid()) {
                ...
                if (this.isLoading === false) {
                    ...
                    this.isLoading = true;
                    self.$http.post('/subscription/purchase', data).then(function (response) {
                        if (response.body == 'success') {
                            _this.subscriptionSuccess = true;
                        } else if (response.body == 'userexists') {
                            swal({
        ...
        addUserToSubscription: function addUserToSubscription() {
            var first_name = this.userForSubscriptionName;
            var last_name = this.userForSubscriptionLastName;
            var email = this.userForSubscriptionEmail;
            this.userForSubscriptionName = '';
            this.userForSubscriptionLastName = '';
            this.userForSubscriptionEmail = '';
            this.usersForSubscription.push({ 'first_name': first_name, 'last_name': last_name, 'email': email });
            this.$els.userForSubscriptionName.focus();
            this.numUsersAdded++;
        },
        removeUser: function removeUser(user) {
            for (var i = 0; i < this.usersForSubscription.length; i++) {
                if (this.usersForSubscription[i] === user) {
                    this.usersForSubscription.splice(i, 1);
                    this.numUsersAdded--;
                    break;
                }
            }
    ...
    events: {
        'user-logged-in-and-can-register': function userLoggedInAndCanRegister(loggedInUser) {
            this.loggedInUser = loggedInUser;
            this.userFullName = this.loggedInUser.first_name + ' ' + this.loggedInUser.last_name;
        },
        'already-logged-in-user': function alreadyLoggedInUser(loggedInUser) {
            this.loggedInUser = loggedInUser;
            if (this.loggedInUser.customer.address != null) {
                this.userFullName = this.loggedInUser.first_name + ' ' + this.loggedInUser.last_name;
                this.memberAddress = this.loggedInUser.customer.address.address;
    ...
    watch: {
        'memberCountry': function memberCountry(val) {
            var selectedCountry = this.countries.filter(function (v) {
                return v.ulkeno == val;
            })[0];
            this.selectedCountryName = selectedCountry.ulke_name;
            if (val != 1) {
                this.showForeign = true;
            } else {
                this.showForeign = false;
                this.memberForeignCity = '';
            }
        },
        'memberCity': function memberCity(val) {
            var selectedCity = this.cities.filter(function (v) {
                return v.sehirno == val;
            })[0];
            this.selectedCityName = selectedCity.sehir_name;
        },
        'picked': function picked(val) {
            if (val == 'person') {
                this.differentBillingCompany = false;
                this.differentBillingInstitution = false;
                this.differentBillingPerson = true;
                this.billingNameLabel = 'ad, soyad';
            } else if (val == 'company') {
                this.differentBillingCompany = true;
                this.differentBillingInstitution = false;
                this.differentBillingPerson = false;
                this.billingNameLabel = 'şirket adı';
            } else if (val == 'institution') {
                this.differentBillingCompany = false;
                this.differentBillingInstitution = true;
                this.differentBillingPerson = false;
                this.billingNameLabel = 'kurum adı';
            }
        },
        'sameBillingCheckbox': function sameBillingCheckbox(val) {
            if (val) {
                this.picked = 'person';
            }
        },
        'selectedSubscriptionType': function selectedSubscriptionType(val) {
            var self = this;
            var type = this.subscriptionTypes.filter(function (val) {
                return val.id == self.selectedSubscriptionType;
            })[0];
            this.pricePerUser = type.ppm;
        }
    }
};
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<div class=\"container\">\n    <form id=\"subscriptionForm\">\n    <div class=\"row\">\n            <div class=\"col-sm-12\">\n                <ul class=\"breadcrumb\">\n                    <li><a href=\"#\">Ana Sayfa</a></li>\n                    <li>Abonelik</li>\n                </ul>\n            </div>\n            <div class=\"row\">\n                <div class=\"col-sm-12\" v-show=\"subscriptionStart\">\n                    <div class=\"approve-box\">\n                        <i class=\"icon ion-checkmark-circled\"></i>\n                        <h1 class=\"theme-font\">İşleminiz başarıyla tamamlanmıştır.</h1>\n                        <p>Aboneliğiniz başlamıştır.</p>\n                    </div>\n                    <div class=\"clearfix\"></div>\n                </div>\n                <div class=\"col-sm-12\" v-show=\"showSubscriptionError\">\n                    <div class=\"disapprove-box\">\n                        <i class=\"icon ion-close-circled\"></i>\n                        <h1 class=\"theme-font\">İşleminiz tamamlanamadı.</h1>\n                        <p>Lütfen Tekrar Deneyin.</p>\n                    </div>\n                    <div class=\"clearfix\"></div>\n                </div>\n            </div>\n            <div v-show=\"!subscriptionSuccess &amp;&amp; !subscriptionStart\">\n            <main class=\"col-sm-12\" v-show=\"step1\">\n                <div class=\"form-box\">\n                    <section>\n                        <div class=\"wizard\">\n                            <div class=\"wizard-inner\">\n                                <div class=\"connecting-line\"></div>\n                                <ul class=\"nav nav-tabs\" role=\"tablist\">\n                                    <li role=\"presentation\" class=\"active\">\n                                        <a href=\"#step1\" data-toggle=\"tab\" aria-controls=\"step1\" role=\"tab\" title=\"Step 1\" @click=\"goToStep1()\">\n                                            <span class=\"round-tab\">\n                                                <i class=\"icon ion-ios-color-wand\"></i>\n                                            </span>\n                                        </a>\n                                    </li>\n                                    <li role=\"presentation\">\n                                        <a href=\"#step2\" data-toggle=\"tab\" aria-controls=\"step2\" role=\"tab\" title=\"Step 2\" @click=\"goToStep2()\">\n                                            <span class=\"round-tab\">\n                                                <i class=\"icon ion-ios-list\"></i>\n                                            </span>\n                                        </a>\n                                    </li>\n                                    <li role=\"presentation\">\n                                        <a href=\"#step3\" data-toggle=\"tab\" aria-controls=\"step3\" role=\"tab\" title=\"Step 3\" @click=\"goToStep3()\">\n                                            <span class=\"round-tab\">\n                                                <i class=\"icon ion-card\"></i>\n                                            </span>\n                                        </a>\n                                    </li>\n                                    <li role=\"presentation\">\n                                        <a href=\"#complete\" data-toggle=\"tab\" aria-controls=\"complete\" role=\"tab\" title=\"Complete\" @click=\"goToStep4()\">\n                                            <span class=\"round-tab\">\n                                                <i class=\"icon ion-checkmark\"></i>\n                                            </span>\n                                        </a>\n                                    </li>\n                                </ul>\n                            </div>\n                        </div>\n                    </section>\n                    <div v-for=\"type in subscriptionTypes\" class=\"col-xs-12 col-sm-6 col-md-3 pricing\">\n                        <ul class=\"p-g{{ type.id }}\">\n                            <li>\n                                <big>{{ type.title }}</big>\n                            </li>\n                            <li v-if=\"type.user_max == 0\">{{ type.user_min }}+ Kullanıcı</li>\n                            <li v-else=\"\">{{ type.numUsers }} Kullanıcı</li>\n                            <li v-show=\"type.user_max == 0\">\n                                Satış Ekibimizin sizinle irtibata geçmesi için lütfen aşağıdaki butona tıklayın.\n                            </li>\n                            <li v-show=\"type.id == 2\">\n                                Ekibinizle kullanın, %10 daha az ödeyin\n                            </li>\n                            <li v-show=\"type.id == 3\">\n                                Kurumsal planı seçin, %20 daha az ödeyin\n                            </li>\n                            <li v-show=\"type.monthly_allowed == 1\">\n                                Aylık ödeyin\n                            </li>\n                            <li v-show=\"type.monthly_allowed == 1\">\n                                İstediğiniz zaman aboneliğinizi sona erdirin\n                            </li>\n                            <li v-show=\"type.user_max > 1\">\n                                <h5 class=\"numUsersLabel\">Kullanıcı Sayısı Belirleyin</h5>\n                                <a class=\"numUsers\" v-show=\"getUserNumForId(type.id) > type.user_min\" @click=\"decreaseUserNum(type.id)\">-</a>\n                                <span class=\"numUsers\" id=\"numUsers{{ type.id }}\">{{ getUserNumForId(type.id)  }}</span>\n                                <a class=\"numUsers\" v-show=\"getUserNumForId(type.id) < type.user_max\" @click=\"increaseUserNum(type.id)\">+</a>\n                            </li>\n                            <li v-show=\"type.monthly_allowed == 1\">\n                                <h3>{{ type.ppm }}</h3>\n                                <span v-show=\"type.user_max > 1\">TL / ay / kullanıcı</span>\n                                <span v-show=\"type.user_max == 1\">TL / ay</span>\n                            </li>\n                        </ul>\n                        <a href=\"/request_quote\" class=\"btn-icon w-150\" v-show=\"type.user_max == 0\">\n                            <div>bilgi al</div>\n                            <span class=\"btn-icon pull-right\">\n                                <i class=\"icon ion-chevron-right\"></i>\n                            </span>\n                        </a>\n                        <a href=\"javascript:void(0)\" class=\"btn-icon w-150\" v-show=\"type.user_max != 0\" @click=\"checkLoginStatusAndGo(type.id)\">\n                            <div>abone ol</div>\n                            <span class=\"btn-icon pull-right\">\n                                <i class=\"icon ion-chevron-right\"></i>\n                            </span>\n                        </a>\n                    </div>\n                    <div class=\"clearfix\"></div>\n                </div>\n            </main>\n            <main class=\"col-sm-12\" v-show=\"step2\">\n                <div class=\"form-box\">\n                    <section>\n                        <div class=\"wizard\">\n                            <div class=\"wizard-inner\">\n                                <div class=\"connecting-line\"></div>\n                                <ul class=\"nav nav-tabs\" role=\"tablist\">\n                                    <li role=\"presentation\">\n                                        <a href=\"#step1\" data-toggle=\"tab\" aria-controls=\"step1\" role=\"tab\" title=\"Step 1\" @click=\"goToStep1()\">\n                                            <span class=\"round-tab\">\n                                                <i class=\"icon ion-ios-color-wand\"></i>\n                                            </span>\n                                        </a>\n                                    </li>\n                                    <li role=\"presentation\" class=\"active\">\n                                        <a href=\"#step2\" data-toggle=\"tab\" aria-controls=\"step2\" role=\"tab\" title=\"Step 2\">\n                                            <span class=\"round-tab\">\n                                                <i class=\"icon ion-ios-list\"></i>\n                                            </span>\n                                        </a>\n                                    </li>\n                                    <li role=\"presentation\">\n                                        <a href=\"#step3\" data-toggle=\"tab\" aria-controls=\"step3\" role=\"tab\" title=\"Step 3\" @click=\"goToStep3()\">\n                                            <span class=\"round-tab\">\n                                                <i class=\"icon ion-card\"></i>\n                                            </span>\n                                        </a>\n                                    </li>\n                                    <li role=\"presentation\">\n                                        <a href=\"#complete\" data-toggle=\"tab\" aria-controls=\"complete\" role=\"tab\" title=\"Complete\" @click=\"goToStep4()\">\n                                            <span class=\"round-tab\">\n                                                <i class=\"icon ion-checkmark\"></i>\n                                            </span>\n                                        </a>\n                                    </li>\n                                </ul>\n                            </div>\n                        </div>\n                    </section>\n                    <div class=\"col-md-6\" id=\"contactdetails\">\n                        <h4>İletişim bilgileri</h4><hr>\n                        <div class=\"form-group\" id=\"membernameinfo\">\n                            <label class=\"control-label col-md-3\">ad </label>\n                            <div class=\"col-md-8\">\n                                <input class=\"form-control\" name=\"membernameinfoV\" type=\"text\" v-model=\"memberName\">\n                            </div>\n                            <div class=\"col-md-1\">&nbsp;</div>\n                        </div>\n                        <div class=\"form-group\" id=\"memberlastnameinfo\">\n                            <label class=\"control-label col-md-3\">soyad </label>\n                            <div class=\"col-md-8\">\n                                <input class=\"form-control\" name=\"memberlastnameinfoV\" type=\"text\" v-model=\"memberLastName\">\n                            </div>\n                            <div class=\"col-md-1\">&nbsp;</div>\n                        </div>\n                        <div class=\"form-group\" id=\"memberemailinfo\">\n                            <label class=\"control-label col-md-3\">e-posta </label>\n                            <div class=\"col-md-8\">\n                                <input class=\"form-control\" id=\"memberEmailInfo\" name=\"memberEmailInfo\" type=\"text\" v-model=\"memberEmail\">\n                            </div>\n                            <div class=\"col-md-1\">&nbsp;</div>\n                        </div>\n                        <div class=\"form-group\" id=\"memberpasswordinfo\" v-show=\"!loggedInUserExists()\">\n                            <label class=\"control-label col-md-3\">şifre </label>\n                            <div class=\"col-md-8\">\n                                <input class=\"form-control\" name=\"memberPasswordInfo\" type=\"password\" v-model=\"memberPassword\">\n                            </div>\n                            <div class=\"col-md-1\">&nbsp;</div>\n                        </div>\n                        <div class=\"form-group addressinfo\">\n                            <label class=\"control-label col-md-3\">adres </label>\n                            <div class=\"col-md-8\">\n                                <input type=\"text\" class=\"form-control\" name=\"address\" v-model=\"memberAddress\">\n                            </div>\n                            <div class=\"col-md-1\">&nbsp;</div>\n                        </div>\n                        <div class=\"form-group districtinfo\">\n                            <label class=\"control-label col-md-3\">i̇lçe/semt </label>\n                            <div class=\"col-md-8\">\n                                <input type=\"text\" class=\"form-control\" name=\"district\" v-model=\"memberDistrict\">\n                            </div>\n                            <div class=\"col-md-1\">&nbsp;</div>\n                        </div>\n                        <div class=\"form-group\">\n                            <label class=\"control-label col-md-3\">ülke </label>\n                            <div class=\"col-md-8\">\n                                <select name=\"country_id\" id=\"country_list\" class=\"form-control\" v-model=\"memberCountry\">\n                                    <option value=\"\"></option>\n                                    <option v-for=\"country in countries\" value=\"{{ country.ulkeno }}\">{{ country.ulke_name }}</option>\n                                </select>\n                            </div>\n                            <div class=\"col-md-1\">&nbsp;</div>\n                        </div>\n                        <div class=\"form-group cityinfo\" v-show=\"!showForeign\">\n                            <label class=\"control-label col-md-3\">şehir </label>\n                            <div class=\"col-md-8\">\n                                <select name=\"city_id\" id=\"city_list\" class=\"form-control\" v-model=\"memberCity\">\n                                    <option value=\"\"></option>\n                                    <option v-for=\"city in cities\" value=\"{{ city.sehirno }}\">{{ city.sehir_name }}</option>\n                                </select>\n                            </div>\n                            <div class=\"col-md-1\">&nbsp;</div>\n                        </div>\n                        <div class=\"form-group foreigncityinfo\" style=\"display: none;\" v-show=\"showForeign\">\n                            <label class=\"control-label col-md-3\">şehir </label>\n                            <div class=\"col-md-8\">\n                                <input type=\"text\" class=\"form-control\" name=\"foreigncity\" v-model=\"memberForeignCity\">\n                            </div>\n                            <div class=\"col-md-1\">&nbsp;</div>\n                        </div>\n                        <div class=\"form-group\">\n                            <label class=\"control-label col-md-3\">telefon </label>\n                            <div class=\"col-md-8\">\n                                <input type=\"text\" class=\"form-control\" name=\"phone\" data-inputmask=\"'mask': '(999) 999 9999'\" v-model=\"memberPhone\">\n                            </div>\n                            <div class=\"col-md-1\">&nbsp;</div>\n                        </div>\n                        <div class=\"form-group personidinfo\">\n                            <label class=\"control-label col-md-3\">tc kimlik no </label>\n                            <div class=\"col-md-8\">\n                                <input type=\"text\" class=\"form-control\" name=\"id_no\" v-model=\"memberIDNo\">\n                            </div>\n                            <div class=\"col-md-1\">&nbsp;</div>\n                        </div>\n                 </div>\n                  <div class=\"col-md-6\" id=\"differentbilling\">\n                        <h4>fatura bilgileri</h4><hr>\n                        <div class=\"form-group\">\n                            <label class=\"control-label col-md-3\"></label>\n                            <div class=\"col-md-9\">\n                                <input type=\"checkbox\" name=\"sameBillingInfo\" id=\"sameBillingInfo\" value=\"true\" v-model=\"sameBillingCheckbox\" checked=\"\">\n                                &nbsp;&nbsp;&nbsp;Fatura bilgileri aynıdır.\n                            </div>\n                        </div>\n                        <hr>\n                        <div class=\"form-group\">\n                            <div class=\"col-md-12\">\n                                <div class=\"row\">\n                                    <div class=\"col-md-4\">\n                                        <input type=\"radio\" value=\"person\" v-model=\"picked\" checked=\"\" :disabled=\"sameBillingCheckbox\">\n                                        <label for=\"one\"> kişi</label>\n                                    </div>\n                                    <div class=\"col-md-4\">\n                                        <input type=\"radio\" value=\"company\" v-model=\"picked\" :disabled=\"sameBillingCheckbox\">\n                                        <label for=\"two\"> şirket</label>\n                                    </div>\n                                    <div class=\"col-md-4\">\n                                        <input type=\"radio\" value=\"institution\" v-model=\"picked\" :disabled=\"sameBillingCheckbox\">\n                                        <label for=\"three\"> kurum</label>\n                                    </div>\n                                </div>\n                            </div>\n                        </div>\n                        <div class=\"form-group\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"değiştirmek için 'fatura bilgileri aynıdır' seçeneğini kaldırın.\">\n                            <label class=\"control-label col-md-3\" id=\"taxpayer\">{{ billingNameLabel }}</label>\n                            <div class=\"col-md-8\">\n                                <input class=\"form-control\" name=\"billingNameInfo\" type=\"text\" placeholder=\"\" :value=\"userFullName\" :disabled=\"sameBillingCheckbox\" v-model=\"billingNameInfo\">\n                            </div>\n                        </div>\n                        <div class=\"form-group billingaddressinfo\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"değiştirmek için 'fatura bilgileri aynıdır' seçeneğini kaldırın.\">\n                            <label class=\"control-label col-md-3\">adres </label>\n                            <div class=\"col-md-8\">\n                                <input type=\"text\" class=\"form-control\" name=\"billingAddress\" :disabled=\"sameBillingCheckbox\" :value=\"(sameBillingCheckbox) ? memberAddress : ''\" }}=\"\" v-model=\"billingAddress\">\n                            </div>\n                        </div>\n                        <div class=\"form-group billingdistrictinfo\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"değiştirmek için 'fatura bilgileri aynıdır' seçeneğini kaldırın.\">\n                            <label class=\"control-label col-md-3\">i̇lçe/semt </label>\n                            <div class=\"col-md-8\">\n                                <input type=\"text\" class=\"form-control\" name=\"billingDistrict\" :disabled=\"sameBillingCheckbox\" :value=\"(sameBillingCheckbox) ? memberDistrict : ''\" v-model=\"billingDistrict\">\n                            </div>\n                        </div>\n                        <div class=\"form-group\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"değiştirmek için 'fatura bilgileri aynıdır' seçeneğini kaldırın.\">\n                            <label class=\"control-label col-md-3\">ülke </label>\n                            <div class=\"col-md-8\">\n                                <select name=\"billing_country_id\" id=\"billing_country_list\" class=\"form-control\" :disabled=\"sameBillingCheckbox\" v-model=\"billing_country_id\">\n                                    <option value=\"\"></option>\n                                    <option v-for=\"country in countries\" value=\"{{ country.ulkeno }}\" :selected=\"sameBillingCheckbox &amp;&amp; country.ulkeno == memberCountry\">{{ country.ulke_name }}</option>\n                                </select>\n                            </div>\n                        </div>\n                        <div class=\"form-group billingCityInfo\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"Değiştirmek için 'Fatura Bilgileri Aynıdır' seçeneğini kaldırın.\" v-show=\"!showForeign\">\n                            <label class=\"control-label col-md-3\">şehir </label>\n                            <div class=\"col-md-8\">\n                                <select name=\"billing_city_id\" id=\"billing_city_list\" class=\"form-control\" :disabled=\"sameBillingCheckbox\" v-model=\"billing_city_id\">\n                                    <option value=\"\"></option>\n                                    <option v-for=\"city in cities\" value=\"{{ city.sehirno }}\" :selected=\"sameBillingCheckbox &amp;&amp; city.sehirno == memberCity\">{{ city.sehir_name }}</option>\n                                </select>\n                            </div>\n                        </div>\n                        <div class=\"form-group billingforeigncityinfo\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"değiştirmek için 'fatura bilgileri aynıdır' seçeneğini kaldırın.\" v-show=\"showForeign\">\n                            <label class=\"control-label col-md-3\">şehir </label>\n                            <div class=\"col-md-8\">\n                                <input type=\"text\" class=\"form-control\" name=\"billingForeigncity\" :disabled=\"sameBillingCheckbox\" :value=\"(sameBillingCheckbox) ? memberForeignCity : ''\" v-model=\"billingForeignCity\">\n                            </div>\n                        </div>\n                        <div class=\"form-group\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"değiştirmek için 'fatura bilgileri aynıdır' seçeneğini kaldırın.\">\n                            <label class=\"control-label col-md-3\">telefon </label>\n                            <div class=\"col-md-8\">\n                                <input type=\"text\" class=\"form-control\" name=\"billingPhone\" data-inputmask=\"'mask': '(999) 999 9999'\" :disabled=\"sameBillingCheckbox\" :value=\"(sameBillingCheckbox) ? memberPhone : ''\" v-model=\"billingPhone\">\n                            </div>\n                        </div>\n                        <div class=\"form-group billingPersonIDInfo\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"Değiştirmek için 'Fatura Bilgileri Aynıdır' seçeneğini kaldırın.\" v-show=\"differentBillingPerson\">\n                            <label class=\"control-label col-md-3\">tc kimlik no</label>\n                            <div class=\"col-md-8\">\n                                <input type=\"text\" class=\"form-control\" name=\"billing_id_no\" :disabled=\"sameBillingCheckbox\" :value=\"(sameBillingCheckbox) ? memberIDNo : ''\" v-model=\"billing_id_no\">\n                            </div>\n                        </div>\n                        <div class=\"form-group billingTaxInfo\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"Değiştirmek için 'Fatura Bilgileri Aynıdır' seçeneğini kaldırın.\" v-show=\"differentBillingCompany || differentBillingInstitution\">\n                            <label class=\"control-label col-md-3\" style=\"padding-right: 0px\">vergi dairesi </label>\n                            <div class=\"col-md-8\">\n                                <input type=\"text\" class=\"form-control\" name=\"billing_tax_office\" :disabled=\"sameBillingCheckbox\" v-model=\"billing_tax_office\">\n                            </div>\n                        </div>\n                        <div class=\"form-group billingTaxInfo\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"Değiştirmek için 'Fatura Bilgileri Aynıdır' seçeneğini kaldırın.\" v-show=\"differentBillingCompany || differentBillingInstitution\">\n                            <label class=\"control-label col-md-3\">vergi no </label>\n                            <div class=\"col-md-8\">\n                                <input type=\"text\" class=\"form-control\" name=\"billing_tax_no\" :disabled=\"sameBillingCheckbox\" v-model=\"billing_tax_no\">\n                            </div>\n                        </div>\n                    </div>\n                    <div style=\"margin-top:30px;\" class=\"row\">\n                        <div class=\"col-md-7\" style=\"margin-top:20px;padding-left:15px;\" v-show=\"usersLeftToAdd() > 0\">\n                            diğer kullanıcıları ekleyin<br>\n                            <input type=\"text\" name=\"userForSubscriptionName\" v-model=\"userForSubscriptionName\" placeholder=\"Adı\" v-el:user-for-subscription-name=\"\">\n                            <input type=\"text\" name=\"userForSubscriptionLastName\" v-model=\"userForSubscriptionLastName\" placeholder=\"Soyadı\">\n                            <input type=\"text\" name=\"userForSubscriptionEmail\" v-model=\"userForSubscriptionEmail\" placeholder=\"E-Posta\">\n                            <a @click=\"addUserToSubscription\">Ekle</a>\n                        </div>\n                        <div class=\"col-md-5\" style=\"margin-top:20px;padding-left:15px;\">\n                            <ul>\n                                <li v-for=\"user in usersForSubscription\">\n                                    {{ user.first_name }} {{ user.last_name }} - {{ user.email }} | <a @click=\"removeUser(user)\">Çıkart</a>\n                                </li>\n                            </ul>\n                        </div>\n                    </div>\n                    <div class=\"col-sm-12 text-right sbmt-btns\">\n                        <hr> <div class=\"row\" style='padding-top: 15px;'><center><div class=\"g-recaptcha\" data-sitekey=\"6Le1u3cpAAAAAIdV1ehUUwFk2Vx46yD_U1KKF2Lb\" data-action=\"checkout\"></div> </center></div>  <hr>\n                        <button type=\"button\" class=\"btn btn-jurix\" @click=\"back\">Geri</button>\n                        <button type=\"button\" class=\"btn btn-default\" @click=\"prepare\">İleri</button>\n                    </div>\n                    <div class=\"clearfix\"></div>\n                    </div>\n                </main>\n                <main class=\"col-sm-12\" v-show=\"step3\">\n                    <div class=\"form-box\">\n                        <section>\n                            <div class=\"wizard\">\n                                <div class=\"wizard-inner\">\n                                    <div class=\"connecting-line\"></div>\n                                        <ul class=\"nav nav-tabs\" role=\"tablist\">\n                                        <li role=\"presentation\">\n                                            <a href=\"#step1\" data-toggle=\"tab\" aria-controls=\"step1\" role=\"tab\" title=\"Step 1\" @click=\"goToStep1()\">\n                                                <span class=\"round-tab\">\n                                                    <i class=\"icon ion-ios-color-wand\"></i>\n                                                </span>\n                                            </a>\n                                        </li>\n                                        <li role=\"presentation\">\n                                            <a href=\"#step2\" data-toggle=\"tab\" aria-controls=\"step2\" role=\"tab\" title=\"Step 2\" @click=\"goToStep2()\">\n                                                <span class=\"round-tab\">\n                                                    <i class=\"icon ion-ios-list\"></i>\n                                                </span>\n                                            </a>\n                                        </li>\n                                        <li role=\"presentation\" class=\"active\">\n                                            <a href=\"#step3\" data-toggle=\"tab\" aria-controls=\"step3\" role=\"tab\" title=\"Step 3\">\n                                                <span class=\"round-tab\">\n                                                    <i class=\"icon ion-card\"></i>\n                                                </span>\n                                            </a>\n                                        </li>\n                                        <li role=\"presentation\">\n                                            <a href=\"#complete\" data-toggle=\"tab\" aria-controls=\"complete\" role=\"tab\" title=\"Complete\" @click=\"goToStep4()\">\n                                                <span class=\"round-tab\">\n                                                    <i class=\"icon ion-checkmark\"></i>\n                                                </span>\n                                            </a>\n                                        </li>\n                                    </ul>\n                                </div>\n                            </div>\n                        </section>\n                        <div class=\"row\">\n                            <div class=\"col-xs-12 col-md-6\">\n                                <div class=\"panel panel-default\">\n                                    <div class=\"panel-heading\">Ödeme Bilgileri</div>\n                                    <div class=\"panel-body\">\n                                        <div class=\"form-group\">\n                                            <label for=\"cardName\">Kart Sahibinin Adı ve Soyadı:</label>\n                                            <div class=\"input-group col-sm-12\">\n                                                <input type=\"text\" class=\"form-control\" name=\"cc_name\" v-model=\"CCnameOnCard\">\n                                            </div>\n                                        </div>\n                                        <div class=\"form-group\">\n                                            <label for=\"cardNumber\">Kredi Kartı Numarası</label>\n                                            <div class=\"input-group col-sm-12\">\n                                                <input type=\"text\" class=\"form-control\" name=\"cc_number\" v-model=\"CCnumber\">\n                                            </div>\n                                        </div>\n                                        <div class=\"row\">\n                                            <div class=\"col-xs-7 col-md-7\">\n                                                <div class=\"form-group\" style=\"margin-top:0px;\">\n                                                    <label for=\"expiryMonth\">Son Kullanma Tarihi</label>\n                                                    <div class=\"col-xs-6 col-lg-6 pl-ziro\" style=\"padding-left:0px;\">\n                                                        <input type=\"text\" class=\"form-control\" id=\"expiryMonth\" placeholder=\"AY\" maxlength=\"2\" v-model=\"CCexpireMonth\" name=\"CCexpireMonth\">\n                                                    </div>\n                                                    <div class=\"col-xs-6 col-lg-6 pl-ziro\" style=\"padding-left:0px;\">\n                                                        <input type=\"text\" class=\"form-control\" id=\"expiryYear\" placeholder=\"YIL\" maxlength=\"2\" v-model=\"CCexpireYear\" name=\"CCexpireYear\">\n                                                    </div>\n                                                </div>\n                                            </div>\n                                            <div class=\"col-xs-5 col-md-5 pull-right\">\n                                                <div class=\"form-group\" style=\"margin-top:0px;\">\n                                                    <label for=\"cvCode\">CVV</label>\n                                                    <input type=\"text\" class=\"form-control\" name=\"cc_cvv2\" v-model=\"CCcvv\">\n                                                </div>\n                                            </div>\n                                        </div>\n                                   </div>\n                                </div>\n                            </div>\n                            <div class=\"col-xs-12 col-md-6 well\">\n                                <h3 style=\"text-align: left;\">Jurix deneyiminize başlamak için ödeme bilgilerinizi girin.</h3>\n                                <ul style=\"padding-left: 15px;\">\n                                    <li>Jurix deneyimine başlamak için son 2 adım!</li>\n                                    <li style=\"margin-top: 10px;\">Abonelik bedeli her ay kredi kartınızdan otomatik olarak çekilecektir.</li>\n                                    <li style=\"margin-top: 10px;\">Aboneliğinizi sona erdirmek istediğinizde, hesabınıza girip iptal seçeneğini işaretlemeniz yeterlidir.</li>\n                                    <li style=\"margin-top: 10px;\">Hizmetten kesintisiz olarak faydalanmak için lütfen takip eden aylarda kredi kartı bakiyenizin müsait olduğundan emin olun.</li>\n                                    <li style=\"margin-top: 10px;\">Kartınızın son kullanma tarihi yaklaşıyorsa endişelenmeyin, bilgileri güncellemeniz için bir bilgilendirme e-maili göndereceğiz.</li>\n                                </ul>\n                            </div>\n                        </div>\n                        <div class=\"col-sm-12 text-right sbmt-btns\">\n                            <hr>\n                            <button type=\"button\" class=\"btn btn-jurix\" @click=\"back\">Geri</button>\n                            <button type=\"button\" class=\"btn btn-default\" @click=\"forward\">İleri 2</button>\n                        </div>\n                        <div class=\"clearfix\"></div>\n                    </div>\n                </main>\n                <main class=\"col-sm-12\" v-show=\"step4\">\n                    <div class=\"form-box\">\n                        <section>\n                            <div class=\"wizard\">\n                                <div class=\"wizard-inner\">\n                                    <div class=\"connecting-line\"></div>\n                                    <ul class=\"nav nav-tabs\" role=\"tablist\">\n                                        <li role=\"presentation\">\n                                            <a href=\"#step1\" data-toggle=\"tab\" aria-controls=\"step1\" role=\"tab\" title=\"Step 1\" @click=\"goToStep1()\">\n                                                <span class=\"round-tab\">\n                                                    <i class=\"icon ion-ios-color-wand\"></i>\n                                                </span>\n                                            </a>\n                                        </li>\n                                        <li role=\"presentation\">\n                                            <a href=\"#step2\" data-toggle=\"tab\" aria-controls=\"step2\" role=\"tab\" title=\"Step 2\" @click=\"goToStep2()\">\n                                                <span class=\"round-tab\">\n                                                    <i class=\"icon ion-ios-list\"></i>\n                                                </span>\n                                            </a>\n                                        </li>\n                                        <li role=\"presentation\">\n                                            <a href=\"#step3\" data-toggle=\"tab\" aria-controls=\"step3\" role=\"tab\" title=\"Step 3\" @click=\"goToStep3()\">\n                                                <span class=\"round-tab\">\n                                                    <i class=\"icon ion-card\"></i>\n                                                </span>\n                                            </a>\n                                        </li>\n                                        <li role=\"presentation\" class=\"active\">\n                                            <a href=\"#complete\" data-toggle=\"tab\" aria-controls=\"complete\" role=\"tab\" title=\"Complete\">\n                                                <span class=\"round-tab\">\n                                                    <i class=\"icon ion-checkmark\"></i>\n                                                </span>\n                                            </a>\n                                        </li>\n                                    </ul>\n                                </div>\n                            </div>\n                        </section>\n                        <div>\n                            <h3 class=\"block\">İşlem Özeti</h3>\n                            <div class=\"row\">\n                                <div class=\"col-md-12\">\n                                    <div class=\"table-responsive\">\n                                        <table class=\"table table-striped\">\n                                            <thead>\n                                                <tr>\n                                                    <th class=\"col-md-6\">Ürün</th>\n                                                    <th class=\"col-md-2 text-right\">Kullanıcı Sayısı</th>\n                                                    <th class=\"col-md-2 text-right\">Fiyat</th>\n                                                    <th class=\"col-md-2 text-right\">Tutar</th>\n                                                </tr>\n                                            </thead>\n                                                <tbody>\n                                                    <tr>\n                                                        <td>Aylık Jurix Platform Aboneliği</td>\n                                                        <td class=\"text-right\">{{ getNumUsers() }}</td>\n                                                        <td class=\"text-right\">{{ pricePerUser }}</td>\n                                                        <td class=\"text-right\">{{ (pricePerUser * getNumUsers()).toFixed(2) }}</td>\n                                                    </tr>\n                                                    <tr>\n                                                        <td colspan=\"4\" class=\"VATLine text-right\"><em>%1 KDV dahildir</em></td>\n                                                    </tr>\n                                                    <tr>\n                                                        <td colspan=\"2\">\n                                                            İptal etmemeniz durumunda aboneliğiniz her ay otomatik olarak yenilenecektir.\n                                                        </td>\n                                                        <td colspan=\"2\" class=\"VATLine text-right\">Ödeme Şekli:\n                                                            <span class=\"dd-static\">\n                                                                Kredi Kartı\n                                                            </span>\n                                                        </td>\n                                                    </tr>\n                                                </tbody>\n                                            </table>\n                                        </div>\n                                    </div>\n                                </div>\n                                <div class=\"row well\" style=\"margin-left:0px;margin-right:0px;\">\n                                    <h4 style=\"margin-top:0px; margin-bottom:0px;\">Abonelik Sözleşmesi</h4>\n                                    <div class=\"col-md-6\">\n                                        <h4>Abone Bilgileri</h4>\n                                        <dl class=\"dl-horizontal\">\n                                            <dt>Ad</dt>\n                                            <dd class=\"dd-static\"> {{ memberName }}</dd>\n                                            <dt>Soyad</dt>\n                                            <dd class=\"dd-static\"> {{ memberLastName }}</dd>\n                                            <dt>E-posta</dt>\n                                            <dd class=\"dd-static\"> {{ memberEmail }}</dd>\n                                            <dt>Adres</dt>\n                                            <dd class=\"dd-static\"> {{ memberAddress }}</dd>\n                                            <dt>Semt/İlçe</dt>\n                                            <dd class=\"dd-static\"> {{ memberDistrict }}</dd>\n                                            <dt>Şehir</dt>\n                                            <dd class=\"dd-static\"> {{ (memberForeignCity != '') ? memberForeignCity : selectedCityName }}</dd>\n                                        </dl>\n                                    </div>\n                                    <div class=\"col-md-6\">\n                                        <h4>Hizmet Sağlayıcı Bilgileri</h4>\n                                        <dl class=\"dl-horizontal\">\n                                            <dt>Şirket Adı</dt>\n                                            <dd class=\"dd-static\">Seçkin Yayıncılık Sanayi ve Ticaret A.Ş.</dd>\n                                            <dt>Adres</dt>\n                                            <dd class=\"dd-static\">Mustafa Kemal Mah. 2158. Sok, No:13 - ANKARA</dd>\n                                            <dt>E-posta</dt>\n                                            <dd class=\"dd-static\">seckin@seckin.com.tr</dd>\n                                            <dt>Vergi Dairesi</dt>\n                                            <dd class=\"dd-static\">Maltepe</dd>\n                                            <dt>Vergi No</dt>\n                                            <dd class=\"dd-static\">7580094271</dd>\n                                            <dt>Ticaret Sicil No</dt>\n                                            <dd class=\"dd-static\">152180</dd>\n                                        </dl>\n                                    </div>\n                                </div>\n                                <div class=\"row\">\n                                    <div class=\"col-md-12\">\n                                        <div class=\"contrat\">\n                                            <p dir=\"ltr\" style=\"text-align:center\">\n                                                <strong>Jurix Abonelik Sözleşmesi</strong>\n                                            </p>\n                                            <p>&nbsp;</p>\n                                            <p dir=\"ltr\" style=\"text-align:justify\">\n                                                <strong>TARAFLAR</strong>\n                                            </p>\n                                            <p dir=\"ltr\" style=\"text-align:justify\">\n                                                <strong>Madde 1 –</strong>\n                                                <span style=\"background-color:transparent; color:rgb(89, 89, 89); font-family:arial; font-size:12px\">&nbsp;</span>\n                                            </p>\n                                            <p dir=\"ltr\" style=\"text-align:justify\">\n                                                <span style=\"background-color:transparent; color:rgb(89, 89, 89); font-family:arial; font-size:12px\">Hizmet Sağlayıcı:</span>\n                                                <span style=\"background-color:transparent; color:rgb(89, 89, 89); font-family:arial; font-size:12px\">&nbsp;&nbsp; &nbsp;</span>\n                                                <span style=\"background-color:transparent; color:rgb(89, 89, 89); font-family:arial; font-size:12px\">Seçkin Yayıncılık San. Ve Tic. A.Ş. </span>\n                                            </p>\n                                            <p dir=\"ltr\" style=\"text-align:justify\">\n                                                <span style=\"background-color:transparent; color:rgb(89, 89, 89); font-family:arial; font-size:12px\">&nbsp;&nbsp; &nbsp;</span>\n                                                <span style=\"background-color:transparent; color:rgb(89, 89, 89); font-family:arial; font-size:12px\">Eskişehir Yolu, Mustafa Kemal Mah. 2158. Sok. No:13 Çankaya / ANKARA</span>\n                                            </p>\n                                            <p dir=\"ltr\" style=\"text-align:justify\">\n                                                <span style=\"background-color:transparent; color:rgb(89, 89, 89); font-family:arial; font-size:12px\">&nbsp;&nbsp; &nbsp;</span>\n                                                <span style=\"background-color:transparent; color:rgb(89, 89, 89); font-family:arial; font-size:12px\">Maltepe VD. 7580094271</span>\n                                            </p>\n                                            <p dir=\"ltr\" style=\"text-align:justify\">\n                                                <span style=\"background-color:transparent; color:rgb(89, 89, 89); font-family:arial; font-size:12px\">&nbsp;&nbsp; &nbsp;</span>\n                                                <span style=\"background-color:transparent; color:rgb(89, 89, 89); font-family:arial; font-size:12px\">Tel: 0312 435 30 30</span>\n                                            </p>\n                                            <p dir=\"ltr\" style=\"text-align:justify\">\n                                                <span style=\"background-color:transparent; color:rgb(89, 89, 89); font-family:arial; font-size:12px\">&nbsp;&nbsp; &nbsp;</span>\n                                                <span style=\"background-color:transparent; color:rgb(89, 89, 89); font-family:arial; font-size:12px\">Faks: 0312 435 24 72</span>\n                                            </p>\n                                            <p dir=\"ltr\" style=\"text-align:justify\">\n                                                <span style=\"background-color:transparent; color:rgb(89, 89, 89); font-family:arial; font-size:12px\">&nbsp;&nbsp; &nbsp;</span>\n                                                <span style=\"background-color:transparent; color:rgb(89, 89, 89); font-family:arial; font-size:12px\">E-posta: satis@jurix.com.tr</span>\n                                            </p>\n                                            <p dir=\"ltr\" style=\"text-align:justify\">\n                                                <span style=\"background-color:transparent; color:rgb(89, 89, 89); font-family:arial; font-size:12px\">Kullanıcı:</span>\n                                                <span style=\"background-color:transparent; color:rgb(89, 89, 89); font-family:arial; font-size:12px\">&nbsp;&nbsp; &nbsp;</span>\n                                                <span style=\"background-color:transparent; color:rgb(89, 89, 89); font-family:arial; font-size:12px\">{{ memberName }} {{ memberLastName }}</span>\n                                            </p>\n                                            <p dir=\"ltr\" style=\"text-align:justify\">\n                                                <span style=\"background-color:transparent; color:rgb(89, 89, 89); font-family:arial; font-size:12px\">&nbsp;&nbsp; &nbsp;</span>\n                                                <span style=\"background-color:transparent; color:rgb(89, 89, 89); font-family:arial; font-size:12px\">{{ memberAddress }} {{ memberDistrict }} {{ (memberForeignCity != '') ? memberForeignCity : selectedCityName }}</span>\n                                            </p>\n                                            <p dir=\"ltr\" style=\"text-align:justify\">\n                                                <span style=\"background-color:transparent; color:rgb(89, 89, 89); font-family:arial; font-size:12px\">&nbsp;&nbsp; &nbsp;</span>\n                                                <span style=\"background-color:transparent; color:rgb(89, 89, 89); font-family:arial; font-size:12px\">E-posta: {{ memberEmail }}</span>\n                                            </p>\n                                            <div id=\"legalpjx\"></div>\n                                        </div>\n                                    </div>\n                                </div>\n                                <div class=\"row\">\n                                    <div class=\"col-md-12\">\n                                        <input type=\"checkbox\" id=\"iagree\" name=\"iagree\">\n                                        <label for=\"iagree\" style=\"vertical-align:middle; font-weight:normal; margin-top:10px;\">\n                                        Abonelik Sözleşmesi'ni okudum, yukarıda belirtilen ürün(ler)i belirtilen şartlarla satın almayı kabul ediyorum.\n                                        </label>\n                                    </div>\n                                </div>\n <div class=\"row\">\n                                    <div class=\"col-sm-12 text-right sbmt-btns\">\n                                        <hr>\n                                        <button type=\"button\" class=\"btn btn-jurix\" @click=\"back\">Geri</button>\n                                        <button class=\"btn btn-default\" @click=\"submitForm\">Satın al</button>\n                                    </div>\n                                </div>\n                            </div>\n                        </div>\n                        <div class=\"clearfix\"></div>\n                    </main>\n                </div>\n            </div>\n        </form>\n    </div>\n<div class=\"clearfix\"></div>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-622a2af5", module.exports)
  } else {
    hotAPI.update("_v-622a2af5", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"babel-runtime/core-js/object/keys":2,"babel-runtime/helpers/defineProperty":3,"vue":47,"vue-hot-reload-api":44}],50:[function(require,module,exports){
'use strict';
...
exports.default = {
    data: function data() {
        return {
            ...
            password: '',
            authError: false,
            authErrorText: 'Giriş yapılamadı, lütfen bilgilerinizi kontrol edin.'
        };
    },
    ...
    methods: {
        tryLogin: function tryLogin() {
            ...
            self.$http.post('/login', data).then(function (response) {
                if (response.body == 'redirect_required') {
                    location.reload();
                }
                _this.loggedInUser = response.body;
                self.$dispatch('bridge', 'login-happened', _this.loggedInUser);
                $('#loginModalVue').modal('hide');
        ...
        tryLogout: function tryLogout() {
            ...
            var self = this;
            self.$http.get('/logout').then(function (response) {
                if (response.body == 'redirect_required') {
                    location.reload();
                }
                self.$dispatch('bridge', 'logout-happened');
                _this2.loggedInUser = false;
            });
        }
    },

    events: {
        'payment-error': function paymentError(loggedInUser) {
            this.loggedInUser = loggedInUser;
        },
        'login-success': function loginSuccess(loggedInUser) {},
        'register-success': function registerSuccess(registeredUser) {}
    }
};
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<li v-show=\"!loggedInUser\" class=\"userMenuButton\">\n    <a href=\"#loginModalVue\" data-toggle=\"modal\" class=\"btn btn-default\">\n        <i class=\"icon ion-android-contact\"></i> <span class=\"loginLabel\">Giriş</span>\n    </a>\n</li>\n<li v-show=\"loggedInUser\">\n    <ul class=\"nav navbar-nav\">\n        <li class=\"dropdown\">\n            <a href=\"#\" class=\"btn btn-default dropdown-toggle\" data-toggle=\"dropdown\">\n                {{ loggedInUser.first_name }} {{ loggedInUser.last_name }} <span class=\"glyphicon glyphicon-user pull-right\"></span>\n            </a>\n            <ul class=\"dropdown-menu\">\n                <li><a href=\"/subscription\">Abone ol</a></li>\n                <li><a href=\"/profile\">Bilgilerimi Güncelle</a></li>\n                <li><a href=\"javascript:void(0);\" @click=\"tryLogout()\">Çıkış</a></li>\n            </ul>\n        </li>\n    </ul>\n</li>\n<div id=\"loginModalVue\" class=\"modal fade\">\n    <div class=\"modal-dialog\">\n        <div class=\"modal-content\">\n            <div class=\"modal-body\">\n                <div class=\"form-base\">\n                    <img src=\"/assets/img/logos/logo-color.png\" class=\"logo\" alt=\"\">\n                    <div class=\"clearfix\"></div>\n                    <h2>Jurix’e giriş yapın,<br>keşfetmeye başlayın!</h2>\n                    <div class=\"alert alert-danger\" v-show=\"authError\">\n                        {{ authErrorText }}\n                    </div>\n                    <input type=\"text\" name=\"email\" id=\"emailField\" placeholder=\"e-posta\" value=\"\" autofocus=\"\" v-model=\"email\">\n                    <input type=\"password\" name=\"password\" id=\"passwordField\" placeholder=\"parola\" value=\"\" v-model=\"password\">\n                    <input type=\"submit\" class=\"btn btn-default btn-lg\" value=\"Giriş Yap\" @click=\"tryLogin()\">\n                    <div class=\"col-sm-12\">\n                        <a href=\"#forgotModal\" data-toggle=\"modal\">şifremi unuttum</a>\n                    </div>\n                </div>\n            </div>\n        </div>\n    </div>\n</div>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-1e548ebe", module.exports)
  } else {
    hotAPI.update("_v-1e548ebe", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"vue":47,"vue-hot-reload-api":44}],51:[function(require,module,exports){
'use strict';
...
Vue.component('footer-subscribe', require('./components/FooterSubscribe.vue'));

Vue.validator('validemail', function (val) {
...
new Vue({
    ...
    events: {
        'bridge': function bridge(e) {
            for (var _len = arguments.length, args = Array(_len > 1 ? _len - 1 : 0), _key = 1; _key < _len; _key++) {
                args[_key - 1] = arguments[_key];
            }

            this.$emit.apply(this, [e].concat(args));
            this.$broadcast.apply(this, [e].concat(args));
        }
    }
});

},{"./components/FooterSubscribe.vue":48,"./components/SubscriptionForm.vue":49,"./components/UserMenu.vue":50,"vue-resource":45,"vue-validator":46}]},{},[51]);
